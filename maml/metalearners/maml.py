...
# from maml.gradient_based import gradient_update_parameters, momentum_velocity
...
class ModelAgnosticMetaLearning(object):
    ...
    def __init__(self, model, optimizer=None, step_size=0.1, first_order=False,
                 ...
                 momentum_true=True, beta1=0.9, beta2=0.9, meta_lr = 0.001,
        ...
        self.beta1 = beta1
        self.beta2 = beta2
        self.momentum_true = momentum_true
    ...
    def get_outer_loss(self, batch):
        ...
        for task_id, (train_inputs, train_targets, test_inputs, test_targets) \
            ...
            params, adaptation_results = self.adapt(train_inputs, train_targets,
                ...
                momentum_true=self.momentum_true, beta1=self.beta1, beta2=self.beta2, meta_lr = self.meta_lr,
    ...
    def adapt(self, inputs, targets, is_classification_task=None,
        ...
        init_list = list(OrderedDict(self.model.meta_named_parameters()).values())
        momentum = []
        velocity = []
        
        for i in list(range(len(init_list))):
            momentum.append(torch.zeros_like(init_list[i]))
            velocity.append(torch.zeros_like(init_list[i]))
        ...
        for step in range(num_adaptation_steps):
            ...
            if momentum_true:
                params = momentum_velocity(params, momentum, velocity, 
                                                       self.beta1, self.beta2, self.meta_lr)
